                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="table-responsive table-responsive-data2">
                                <table class="table table-data2">
                                    ...
                                    <tbody>
                                    <c:forEach items="${pageInfo.records==null?users:pageInfo.records}"
                                               var="item">
                                        <tr>
                                            <td>
                                            </td>
                                            ...
                                            <td>
                                                <div class="rs-select2--trans rs-select2--sm" style="width:100px;">
                                                    <select class="data_info js-select2" name="property">
                                                        <option value="3" ${item.authorization==3?'selected="selected"':''}>
                                                            财务
                                                        </option>
                                                        <option value="2" ${item.authorization==2?'selected="selected"':''}>
                                                            人事
                                                        </option>
                                                        <option value="1" ${item.authorization==1?'selected="selected"':''}>
                                                            管理员
                                                        </option>
                                                        <option value="0" ${item.authorization==0?'selected="selected"':''}>
                                                            普通员工
                                                        </option>
                                                    </select>
                                                    <div class="dropDownSelect2"></div>
                                            ...
                                            <td>
                                                <div class="rs-select2--trans rs-select2--sm" style="width:50px;">
                                                    <select class="data_info js-select2" name="property">
                                                        <option value="2" ${item.permission==2?'selected="selected"':''}>
                                                            2
                                                        </option>
                                                        <option value="1" ${item.permission==1?'selected="selected"':''}>
                                                            1
                                                        </option>
                                                        <option value="0" ${item.permission==0?'selected="selected"':''}>
                                                            0
                                                        </option>
                                                    </select>
                                                    <div class="dropDownSelect2"></div>
...
<script>
    ...
    <shiro:hasPermission name="1:0">$(".data_info").attr("disabled","disabled"); $(".delete_btn").hide();</shiro:hasPermission>
    <shiro:hasPermission name="1:1">$(".delete_btn").hide();</shiro:hasPermission>
    ...
    $(".data_info").change(function () {
        ...
        $.ajax({
            ...
            data: {
                ...
                "password": $(this).closest("tr").children("td:eq(2)").find("input").val(),
                "authorization": $(this).closest("tr").children("td:eq(3)").find("select").val(),
                "permission": $(this).closest("tr").children("td:eq(4)").find("select").val()
            },
            dataType: 'json',
