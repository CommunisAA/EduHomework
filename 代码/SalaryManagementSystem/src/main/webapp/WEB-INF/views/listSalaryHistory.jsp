                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="table-data__tool" hidden>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="data_info" maxlength="10"
                                                       ...
                                                       value="${item.postsalary}" readonly/>
                                            </td>
                                            <td>
                                                <input type="text" class="data_info" maxlength="10"
                                                       style="background-color:transparent;border:0;width:50px;"
                                                       oninput="value=value.replace(/[^\d^\.]/g,'')"
                                                       value="${item.scalesalary}" readonly/>
                                            </td>
                                            <td>
                                                <input type="text" class="data_info" maxlength="10"
                                                       style="background-color:transparent;border:0;width:50px;"
                                                       oninput="value=value.replace(/[^\d^\.]/g,'')"
                                                       value="${item.allowance}" readonly/>
                                            </td>
                                            <td>
                                                <input type="text" class="data_info" maxlength="10"
                                                       style="background-color:transparent;border:0;width:100px;"
                                                       oninput="value=value.replace(/[^\d^\.]/g,'')"
                                                       value="${item.performancesalary}" readonly/>
                                            </td>
                                            <td>
                                                <input type="text" class="data_info" maxlength="10"
                                                       style="background-color:transparent;border:0;width:50px;"
...
<script>
    if(window.location.href.indexOf("findSalary") !== -1)
        $("#salaryHistoryQuery").addClass("active");
    else
        $("#salaryHistory").addClass("active");
