                                ...
                                <table class="table table-data2">
                                    ...
                                    <c:forEach items="${pageInfo.records==null?employees:pageInfo.records}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="rs-select2--trans rs-select2--sm" style="width:50px;">
                                                    <select class="data_info js-select2" name="property">
                                                        <option value="男" ${item.sex=='男'?'selected="selected"':''}>
                                                            男
                                                        </option>
                                                        <option value="女" ${item.sex=='女'?'selected="selected"':''}>
                                                            女
                                                        </option>
                                                    </select>
                                                    <div class="dropDownSelect2"></div>
                                            ...
                                            <td>
                                                <input type="text" class="data_info" maxlength="2"
                                                       style="background-color:transparent;border:0;width:50px;"
...
<script>
    ...
    <shiro:hasPermission name="2:0">$(".data_info").attr("disabled","disabled"); $(".delete_btn").hide();</shiro:hasPermission>
    <shiro:hasPermission name="2:1">$(".delete_btn").hide();</shiro:hasPermission>
