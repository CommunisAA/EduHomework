                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="table-data__tool">
                                ...
                                <div>
                                    <form class="form-header" action="findE.do" method="POST">
                                ...
                                <div class="table-data__tool-right" style="visibility: hidden;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-outline-primary"><a
                                                        href="findSalary.do?id=${item.id}">详情</a></button>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                            ...
                            <div class="card-body" style="text-align:center;">
                                <c:if test="${pageInfo.hasPrevious}">
                                    <button type="button" class="btn btn-outline-primary"><a
                                            href="listE.do?page=${pageInfo.current-1}">上一页</a></button>
                                </c:if>
                                <c:if test="${pageInfo.hasNext}">
                                    <button type="button" class="btn btn-outline-info"><a
                                            href="listE.do?page=${pageInfo.current+1}">下一页</a></button>
                                </c:if>
                            </div>
                        </div>
                    </div>
...
<script>
    $("#salaryHistoryQuery").addClass("active");
    ...
    $("#select-page").change(function () {
        window.location.href = "listE.do?page=" + $(this).val();
    });
